...
dependencies {
    ...
    implementation(Ktor2.Server.library("serialization-jackson"))
    implementation(Ktor2.Server.library("server-auth"))
    implementation(Ktor2.Server.library("server-auth-jwt"))
    implementation(Ktor2.Server.library("server-cio"))
    implementation(Ktor2.Server.library("server-content-negotiation"))
    implementation(Ktor2.Server.library("server-metrics-micrometer"))
    implementation(Ktor2.Server.library("server-status-pages"))
