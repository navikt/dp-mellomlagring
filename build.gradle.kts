...
dependencies {
    ...
    implementation("no.nav.dagpenger:ktor-client-metrics:2026.05.04-10.36.d489859941f7")
    ...
    testImplementation("org.jsmart:zerocode-tdd:1.4.3")
    testImplementation("org.jsmart:zerocode-tdd-jupiter:1.4.3")
