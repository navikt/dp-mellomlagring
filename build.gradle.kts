...
dependencies {
    ...
    implementation("no.nav.dagpenger:image-utils:2025.07.23-08.30.31e64aee9725")
    ...
    testImplementation("no.nav.dagpenger:oauth2-klient:2025.07.23-08.30.31e64aee9725")
}
