...
dependencies {
    ...
    implementation("no.nav.dagpenger:image-utils:2025.03.26-08.06.f652e69565e1")
    implementation("no.nav.dagpenger:ktor-client-metrics:2025.03.26-08.06.f652e69565e1")
    ...
    testImplementation("no.nav.dagpenger:oauth2-klient:2025.03.26-08.06.f652e69565e1")
}
